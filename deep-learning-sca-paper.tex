...
\begin{figure}[ht]
	...
	\caption[Short description of a CNN]{The basic structure of a CNN, the trained weights are in the filters of the convolution operation.}
	\label{fig:cnn}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\def\svgwidth{\columnwidth}
	\import{images/}{dlpaper-results2.png}
	\caption[der kurztext]{der langtext}
...
Furthermore, NNs such as Recurrent Neural Networks and its varieties have not been discussed in this paper but might also be interesting 
